"""Audio generation utilities for CSM."""
...
from .models.model import Model, ModelArgs
from .watermarking import CSM_1B_GH_WATERMARK
from .watermarking.utils import load_watermarker, watermark
...
class Generator:
    """Speech generator using the CSM model."""
    ...
    def __init__(
        ...
        Args:
            model: The CSM model to use for generation
        """
        self._model = model
    ...
    def _tokenize_audio(self, audio: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        Args:
            audio: The audio to tokenize
            
        Returns:
            Tokenized audio and mask
        """
        frame_tokens = []
        frame_masks = []
    ...
    def _tokenize_segment(self, segment: Segment) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        Args:
            segment: The segment to tokenize
            
        Returns:
            Tokenized segment and mask
        """
    ...
    def generate(
        ...
        """
        Generate audio for the given text and context.
